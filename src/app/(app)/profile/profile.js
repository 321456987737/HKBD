...
import Myorders from "./myorders/page"; // Adjust the import path as necessary
import Whishlist from "./whishlist/page";
import Address from "./address/page";
import AccountSettings from "./accountsettings/page"; // Adjust the import path as necessary
import {
  UserCircleIcon,
  ShoppingBagIcon,
  HeartIcon,
